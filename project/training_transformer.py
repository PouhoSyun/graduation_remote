...
from project.model.transformer import VQGANTransformer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--con-learning-rate', type=float, default=2.25e-05, help='Learning rate.')
    parser.add_argument('--gan-learning-rate', type=float, default=1e-05, help='Learning rate.')
